...
//
			...
			uniform float _Is_SingleBand;
			uniform float _AudioBand;
			UNITY_DECLARE_TEX2D_NOSAMPLER(_AudioLink_Tex); uniform float4 _AudioLink_Tex_ST;
			//uniform sampler2D _AudioLink_Tex; uniform float4 _AudioLink_Tex_ST;
			uniform float _AudioMix;
			uniform float _AudioEmiPower;
			uniform float _AudioEmiBasePower;
			//
            //v.2.0.7
